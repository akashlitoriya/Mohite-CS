    ...
    <div className='lg:w-[1200px] mx-auto'>
      ...
      <div className='flex flex-col lg:flex-row justify-center items-center lg:min-h-[calc(100vh-7rem)] m-5'>
        <div className='flex gap-7 flex-col'>
            <p className='text-4xl text-center md:text-start md:text-6xl font-bold'>Find  <HighlightedText text={"Partners"} />(CAs)<br></br> available online</p>
            <p className='text-lg text-center md:text-start md:text-xl font-normal text-heroSubheading'><span className='font-bold'>CONNECT</span> with us where your services are listed and visible to a myriad of businesses seeking CA’s for compliance support</p>
        ...
        <div className='relative w-full h-screen  lg:w-[969px] md:h-[500px]'>
