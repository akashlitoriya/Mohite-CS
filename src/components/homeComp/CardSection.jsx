...
const CardSection = () => {
  return (
    <div className='sm:mt-20 md:mt-60 lg:mt-0 m-5'>
      <div className='lg:w-[1200px] mx-auto lg:min-h-[80vh] flex flex-col gap-5 lg:gap-12'>
        <div className='flex flex-col items-center'>
            <p className='text-6xl font-bold'>Want to <HighlightedText text={"Join"}/> Us?</p>
            <p className='text-2xl text-center'>To remain with us, it is essential that you diligently follow the steps provided</p>
        </div>
        <div className='grid grid-flow-row grid-cols-1 grid-rows-6 md:grid-cols-2 md:grid-rows-3 lg:grid-cols-3 lg:grid-rows-2 gap-x-6 gap-y-6'>
            {
                CardData.map((card,index) => (
                    <div className='relative shadow-xl rounded-[20px]' key={index}>
        ...
        <p>* For forms AOC-4 and MGT-7, you will be charged a penalty of ₹200 every day until you file the form . There is no maximum penalty amount. So, if you don't file the form for a year, you will owe ₹73,000 per form</p>
